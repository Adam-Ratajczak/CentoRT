...
public:
	GenCargoTask(const std::vector<std::filesystem::path>& sources, const std::vector<std::filesystem::path>& includeDirs, const std::vector<std::string>& compilerOptions)
		: _sources{ sources }
